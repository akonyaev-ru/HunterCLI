...
* 📈 **Статистика просмотров.** Программа ежедневно запоминает счётчик просмотров каждого резюме и по клавише `S` показывает, что дала неделя: прирост просмотров, сравнение с предыдущей неделей, сколько просмотров принесло одно поднятие и какое резюме работает лучше остальных.
...
| `S` | Статистика просмотров за неделю |
...
| `stats.json` | История просмотров: по одному значению счётчика в сутки на каждое резюме, хранится год. Открытые числа, без шифрования |
